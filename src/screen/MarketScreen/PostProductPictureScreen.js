...
const PostProductPictureScreen = (props) => {
      ...
      <View style={styles.header}>
        ...
        <View style={{ marginRight: 20 }}>
          ...
          <Text style={iOSUIKitTall.button}>ถัดไป</Text>
            <TouchableOpacity
              onPress={() => props.navigation.navigate('PostProductDetail', {
                imageObjArr
              })}
            >
...
export default PostProductPictureScreen;